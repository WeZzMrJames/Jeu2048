...
/**
 * Cette énumération représente la valeur de la tuile dans la grille
 * Je l'utilise pour stocker les nombres et les couleurs
 * 
 *
 */
public enum Value {
    ...
    /**
     * Méthode Factory pour obtenir un de ces cas enum.
     * Ceci est un wrapper de Enum.valueOf ().
     */
